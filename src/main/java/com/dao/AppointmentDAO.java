...
public class AppointmentDAO {
	...
	public boolean addAppointment(Appointment ap)
	{
		boolean f=false;
		try {
			String sql = "insert into appointment(user_id, fullname, gender, age, appoint_date, "
					+ "email, phno, diseases, doctor_id, address, status)" 
					+ "VALUES (? ,? ,? ,? ,? ,? ,? ,? ,? ,? ,?)";
...
//method to update the status in the database in appointment table 	
...
//method to see all the appointments from admin model	
